package com.ohgiraffers.post_st.model.entity;// 엔티티는 컴퓨터 프로그램에서 중요한 물건이나 개념을 나타내는 단어
//API:Application Programming Interface"의 약자로, 응용 프로그램 개발 시에 다른 소프트웨어와 상호 작용할 수 있는 인터페이스를 제공하는 방법이나 규약을 의미합니다.

import jakarta.persistenco.*;// Jakarta Persistence API에 포함된 모든 클래스들을 현재 파일에서 사용할 수 있도록 가져오겠다는 것을 의미합니다. 이는 주로 데이터베이스와 관련된 작업을 할 때 필요한 클래스들을 편리하게 사용할 수 있도록 해줍니다.
